...
export function AnimalCreateForm(): React.JSX.Element {
  ...
  console.log('selectedFiles 12:00 => ', selectedFiles);
 ...
 */}
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Stack spacing={2}>
          ...
          <FormControl>
            <InputLabel>Nome do animal</InputLabel>
            <OutlinedInput label="Nome do animal" />
          </FormControl>
          ...
          {/* <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.userName)}>
                <InputLabel>Espécie do animal</InputLabel>
                <OutlinedInput {...field} label="Espécie do animal" />
                {errors.userName ? <FormHelperText>{errors.userName.message}</FormHelperText> : null}
              </FormControl>
            )}
          /> */}
          ...
          <FormControl>
            <InputLabel>Espécie do animal</InputLabel>
            <OutlinedInput label="Espécie do animal" />
          </FormControl>
          ...
          {/* <Controller
            ...
            render={({ field }) => (
              <FormControl error={Boolean(errors.email)}>
                ...
                <OutlinedInput {...field} label="Observações"/>
                {errors.email ? <FormHelperText>{errors.email.message}</FormHelperText> : null}
              </FormControl>
            )}
          />    */}
          ...
          <FormControl>
            <InputLabel>Observações</InputLabel>
            <OutlinedInput label="Observações" />
          </FormControl>


          {/* <FormControl>
            <FormLabel id="demo-controlled-radio-buttons-group">Status do animal</FormLabel>
            <RadioGroup
            ...
            >
              <FormControlLabel value="0" control={<Radio />} label="Ativado" />
              <FormControlLabel value="1" control={<Radio />} label="Desativado" />
            </RadioGroup>
          </FormControl>     */}
