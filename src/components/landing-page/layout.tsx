...
export function Layout({ children }: LayoutProps): React.JSX.Element {
  ...
  const githubProfileImageUrl = 'https://imagens.ebc.com.br/mIP74J5qtx0y5da18zxaj03tBdo=/1170x700/smart/https://agenciabrasil.ebc.com.br/sites/default/files/thumbnails/image/lajeado_1.jpg?itok=W1tRy1Qm';

  const contact = [
    {
      id: '1',
      title: 'Seja voluntário',
      description: 'VOCÊ CONSEGUE IR PRESENCIALMENTE EM ALGUM ABRIGO E TOPA SER UM VOLUNTÁRIO? Clique no botao abaixo e faça parte dessa corrente solidária. Toda ajuda e importante para fazer o nosso Estado voltar a ser grande.',
      route: 'https://github.com/carloshenriquefarias', 
      logo: <Avatar src={'https://github.githubassets.com/assets/GitHub-Mark-ea2971cee799.png'} variant="square" />,
    },
    {
