...
import { AnimalsListTable } from '@/components/dashboard/animals/animals-list-table';
  ...
  return (
    <Stack spacing={3}>
      <Stack direction="column" spacing={1} sx={{ flex: '1 1 auto', width:'100%'}}>
        ...
        <Typography variant="h4">Lista de animais cadastrados</Typography>
        ...
        <CardActions sx={{ justifyContent: 'space-between', alignItems: 'center', width:'100%'}}>
          <Stack direction="row" sx={{ alignItems: 'center' }}>
            ...
            <CardHeader 
              subheader="Encontre aqui todos os animais que ja foram cadastrados no site" 
